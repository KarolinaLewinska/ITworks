...
draw_plot(languages_stats, 'liczba kursów', 'Najpopularniejsze języki programowania', 'languages.png')
...
draw_plot(topics_stats, 'liczba kursów', 'Najpopularniejsza tematyka kursów', 'topics.png')